              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 text-sm text-neutral-600 hover:text-neutral-900 transition-colors cursor-pointer"
                  >
                ...
                <div className="flex flex-wrap gap-3">
                  {sizeOptions.map((size, index) => {
                    ...
                    return (
                      ...
                      >
                        {String(size) === "ONE_SIZE" ? "One Size" : String(size)}
                      </button>
                    );
                  })}
                </div>
