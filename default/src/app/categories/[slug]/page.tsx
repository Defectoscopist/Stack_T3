...
export default function GlobalCategoryPage() {
  ...
  // Show products for this category across all sexes
      ...
      <div className="max-w-screen-2xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="rounded-4xl bg-gray-100 p-10 mb-12">
          <div className="grid gap-8 lg:grid-cols-[1.4fr_0.9fr] items-center">
            <div>
              ...
              <h1 className="text-5xl font-bold text-black mb-4 capitalize">{title}</h1>
              <p className="text-gray-600 max-w-2xl leading-8">
                Discover our {title.toLowerCase()} selection for men, women, and kids. Quality gear for every adventure.
              </p>
            ...
            <div className="rounded-3xl bg-white p-8 shadow-sm">
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-7">
                  Browse our curated selection of {title.toLowerCase()} for all genders. From bold statement pieces to everyday essentials.
                </p>
                <p className="text-gray-700 leading-7">
        ...
        <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="text-sm text-gray-600 max-w-xl">
            Browse {title.toLowerCase()} for men, women and kids — a mix of best sellers and new arrivals.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="rounded-3xl border border-gray-200 bg-white p-8 text-center text-gray-600">
            <p className="mb-4">No products found for {title}.</p>
