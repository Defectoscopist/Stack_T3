...
module.exports = {
    ...
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          '(^|/)(?:babel|webpack|next|postcss|prettier|eslint|vitest|playwright)[.]config[.](?:js|cjs|mjs|ts|cts|mts|json)$', // tool configs
          // test / spec files
          '[.]test[.](?:js|cjs|mjs|ts|tsx|cts|mts)$',
          '[.]spec[.](?:js|cjs|mjs|ts|tsx|cts|mts)$',
          '(^|/)(__tests__|test|tests|spec|specs|e2e)[^/]*$',
          // Next.js App Router entry files (page/layout/route are entry points)
  ...
  options: {
    ...
    exclude: {
      // path: an array of regular expressions in strings to match against
      path: ['generated', '\\.next', 'test-results', 'playwright-report', 'coverage'],
    },
...
// generated: dependency-cruiser@18.2.0 on 2026-08-17T08:47:49.363Z
